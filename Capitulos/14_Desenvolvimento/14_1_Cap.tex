...
\par A Computação em Nuvem surgiu em 2006 e tornou-se um modelo em que os dados e os programas deixam de ficar no computador local e passam a rodar em grandes centros de armazenamento, acessados pela internet \cite{HENRIQUES2010_CLOUD_COMPUTING_TCC}. A ideia da ``nuvem'' é esconder os equipamentos físicos por trás de uma interface simples, de modo que o poder de computação vira um serviço pago conforme o uso, tratado como uma utilidade pública, a exemplo da água e da energia elétrica \cite{PEDROSA2011_COMPUTACAO_NUVEM}. Para uma plataforma ser de fato uma nuvem, ela precisa reunir cinco características: contratar recursos sozinho e na hora em que precisa, acessar tudo pela rede de qualquer lugar, compartilhar os mesmos recursos entre vários clientes, aumentar ou reduzir a capacidade com rapidez e medir o consumo para a cobrança \cite{HENRIQUES2010_CLOUD_COMPUTING_TCC,PEDROSA2011_COMPUTACAO_NUVEM}. Quanto à forma de implantação, a nuvem pode ser pública, privada, comunitária ou híbrida, sendo esta última capaz de recorrer a recursos públicos para absorver picos de demanda \cite{HENRIQUES2010_CLOUD_COMPUTING_TCC}.
