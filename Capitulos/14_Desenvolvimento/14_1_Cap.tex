...
\par A Internet das Coisas (\emph{Internet of Things}, IoT), termo cunhado por Kevin Ashton em 1999, descreve uma infraestrutura de rede global na qual objetos físicos e virtuais possuem identidade e representação digital e se integram à internet por interfaces inteligentes, trocando informações de forma autônoma \cite{PISCHING2017,BIGHETI2020}. \textcite{STANKOVIC2014_IOT_RESEARCH_DIRECTIONS} a descreve como ponto de convergência entre computação móvel e pervasiva, redes de sensores sem fio e sistemas ciber-físicos, antevendo um cenário em que o sensoriamento ubíquo se torna uma utilidade comparável à eletricidade. Essa escala, da ordem de bilhões a trilhões de dispositivos, impõe desafios de nomeação, autenticação, confiabilidade, armazenamento e privacidade, agravados pelo fato de que dispositivos que atuam sobre o mundo físico tornam falhas uma questão de segurança operacional \cite{STANKOVIC2014_IOT_RESEARCH_DIRECTIONS}.

\par Quando esse paradigma é trazido para o domínio industrial, sensoriamento de processos, controle de máquinas e otimização de cadeias produtivas, recebe o nome de Internet Industrial das Coisas (\emph{Industrial Internet of Things}, IIoT), um subconjunto da IoT especializado para ampliar a eficiência e a responsividade das plantas \cite{BIGHETI2020}. Embora compartilhem o mesmo núcleo, a IoT de consumo e a IIoT diferem em criticidade: a primeira lida com cenários ad-hoc e requisitos brandos, enquanto a segunda envolve nós fixos, altos volumes de dados e exigências rigorosas de tempo real, confiabilidade e segurança \cite{BIGHETI2020}. Para \textcite{PISCHING2017}, a proliferação da IoT na indústria leva fabricantes a embarcar tecnologias que sustentam a convergência TA/TI; e, à medida que dispositivos de campo expõem suas funções como serviços de rede, por exemplo via OPC-UA, a pirâmide ISA-95 tende a achatar-se em uma arquitetura logicamente plana baseada em serviços \cite{COLOMBO2014_STATE_ART_AUTOMATION}.
...
\par O banco de dados é o componente de software responsável por armazenar, organizar e recuperar informações de forma persistente. Diferentes modelos atendem a propósitos distintos: os bancos relacionais favorecem dados estruturados e as relações entre entidades; os de séries temporais, o armazenamento massivo de medições com carimbo de tempo; e os NoSQL (documentais, chave-valor, grafos), cenários de alta variabilidade de esquema.
