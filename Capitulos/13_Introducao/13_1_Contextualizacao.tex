...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{Imagens/Introducao/Contextualizacao/evolucoes-industriais-nova.png}
    \centering
    \vspace{0.2cm} \\
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{Imagens/Introducao/Contextualizacao/piramide-automacao-nova.png}
    \centering
    \vspace{0.2cm} \\
