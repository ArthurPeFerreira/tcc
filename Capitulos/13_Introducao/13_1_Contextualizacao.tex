...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.75\textwidth]{Imagens/Introducao/Contextualizacao/evolucoes-industriais-nova.png}
    \centering
    \vspace{0.2cm} \\
