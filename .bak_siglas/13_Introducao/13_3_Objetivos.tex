...
\begin{itemize}
    ...
    \item Validar o módulo de monitoramento por meio de testes e de um cenário demonstrativo, evidenciando o correto acesso às variáveis e a estabilidade da solução frente ao volume de dados esperado.
\end{itemize}